...
if __name__ == '__main__':
    ...
    if expert == 1:
        ...
        expert=False
    model_path = ''
    print('________________________policy', policy_fn, 'size_board', size_board, 'winning_length', winning_length, 'batch size', BATCH_SIZE,'TEMP_CTE', TEMP_CTE,'seed', seed, 'expert', expert)
    ...
    learn(policy_fn, env, nsteps=size_board * size_board, nstack=1, seed=seed, total_timesteps=10000000,
          ...
          BATCH_SIZE=BATCH_SIZE, TEMP_CTE=TEMP_CTE, expert=expert)
    env.close()
